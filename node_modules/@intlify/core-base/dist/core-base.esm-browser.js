...
export { DEFAULT_MESSAGE_DATA_TYPE, DevToolsLabels, DevToolsPlaceholders, DevToolsTimelineColors, MISSING_RESOLVE_VALUE, NOT_REOSLVED, clearCompileCache, clearDateTimeFormat, clearNumberFormat, compileToFunction, createCompileError, createCoreContext, createCoreError, createEmitter, createMessageContext, datetime, getLocaleChain, getWarnMessage, handleFlatJson, handleMissing, isTranslateFallbackWarn, isTranslateMissingWarn, number, parse, parseDateTimeArgs, parseNumberArgs, parseTranslateArgs, registerMessageCompiler, resolveValue, translate, updateFallbackLocale };
